...
public class RDVRestController {
    ...
    public ResponseEntity<RDV> createRDV(
      ...
      List<AvailableDateHour> dates=  availableDateFeignClient.getAllAvailableDates(); // Fetch available dates if needed
        rdv.setClient(client);
        rdv.setCoiffeur(coiffeur);
        rdv.setService(service);
        rdv.setDateRDV(new DateHour()); // Assuming you want to set a new DateHour here
